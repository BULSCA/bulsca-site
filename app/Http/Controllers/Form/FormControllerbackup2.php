...
class FormController extends Controller
{
    ...
    public function create(CreateNewForm $request)
    {
        try {
            ...
            return back()
                ->withErrors(['msg' => 'Failed to create form'])
                ->withInput();
        }
    }
