...
Route::middleware(['auth', 'verified'])->namespace('Form')->group(function () {
    ...
    Route::get('/forms/{form}/responses/download', [ResponseController::class, 'export'])->name('forms.response.export');
    ...
    //Form Clear all unfinished Routes
    Route::post('/forms/clear-unfinished', [FormController::class, 'clearUnfinishedForms'])->name('forms.clear-unfinished');
