<div class="form-input {{ $css }} @error($id) is-invalid @enderror">
  ...
  <select type="{{ $type }}" @if ($deny==true ) readonly @endif required id="form-link-{{ $id }}" name="{{ $id }}" selected="{{ old($id) ?: $defaultValue }}" class="input" style="padding-top: 0.65em; padding-bottom: 0.65em;">
