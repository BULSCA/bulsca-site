...
<div class=" container-responsive ">
    <div class="flex flex-col space-y-9 ">
        <div class="flex flex-col md:flex-row items-center justify-center md:space-x-12 space-y-6 md:space-y-0 text-center md:text-left w-full">
...
<div class="container-boast" style="background: #004490">
    ...
    <a href="{{ route('champs.2025') }}" rel="noopener noreferrer"
        class="btn btn-thinner md:ml-auto mt-6 md:mt-0">
        Find out More
    </a>
</div>
