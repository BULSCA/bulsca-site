...
@section('content')
  ...
  <div class="h-[50vh] w-screen bg-gray-100  overflow-hidden  ">
    ...
    <div class="h-full w-full overflow-hidden relative">
      <div class="absolute top-0 right-0 w-full h-full head-bg flex items-center justify-center transition-opacity   duration-1000" id="head1">
        <img src="./storage/logo/blogo.png" class="w-[12.5%] h-auto" alt="">
      </div>
  ...
  <div class=" mx-2 md:mx-[20%] my-[2%] ">
    <div class=" grid grid-cols-3 gap-32 text-center">
  ...
  <div class="px-2 md:px-[20%] py-[5%] bg-bulsca flex items-center">
    <h1 class="text-white text-3xl font-bold uppercase">Champs 2022 Kindly sponsored by <span class=" underline underline-offset-3 ">Ben Barker</span> </h1>
    <button class="btn ml-auto flex flex-row items-center">
      Find out more
