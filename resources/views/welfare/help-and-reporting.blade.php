...
<div class="container-boast">
    <div>
        <p class="text-white text-2xl font-bold">
            If you are struggling with your well-being or mental health and would like to speak to someone about this more, please see the resources below:</p>
    </div>
...
<div class="container-responsive">
    ...
    <ul class=" list-disc list-inside indent-4">
        <li><strong>Samaritans</strong> can be contacted anytime for free on 116 123 or by emailing <a href="mailto:jo@samaritans.org">jo@samaritans.org</a> </li>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
            ...
            <ul class=" list-disc list-inside indent-4">
                <li><a href="https://www.studentminds.org.uk/" rel="noopener noreferrer">https://www.studentminds.org.uk/</a> </li>
                <li><a href="https://www.youngminds.org.uk/" rel="noopener noreferrer">https://www.youngminds.org.uk/</a></li>
        ...
        <div>
            ...
            <ul class=" list-disc list-inside indent-4">
                ...
                <li><a href="https://www.victimsupport.org.uk/" rel="noopener noreferrer">https://www.victimsupport.org.uk/ </a></li>
            </ul>
        </div>
        <div>
            ...
            <ul class=" list-disc list-inside indent-4">
                ...
                <li><a href="https://www.blackmindsmatteruk.com/" rel="noopener noreferrer">https://www.blackmindsmatteruk.com/</a></li>
...
<div class="container-responsive">
    ...
    <p>Each of your respective universities has its own well-being services; if you are struggling to find these, they are linked below:
        <br>
        <br>
    <div class=" flex flex-col items-center space-y-2 md:flex-row justify-between">
        <a href="https://intranet.birmingham.ac.uk/student/your-wellbeing/index.aspx" rel="noopener noreferrer">Birmingham</a>
        <a href="https://warwick.ac.uk/services/wss/" rel="noopener noreferrer">Warwick</a>
        <a href="http://www.bristol.ac.uk/students/support/wellbeing/request-support/services/" rel="noopener noreferrer">Bristol</a>
        <a href="https://www.nottingham.ac.uk/studentservices/services/support-and-wellbeing-service.aspx" rel="noopener noreferrer">Nottingham</a>
        ...
        <a href="https://www.plymouth.ac.uk/student-life/services/student-services/counselling" rel="noopener noreferrer">Plymouth</a>
        <a href="https://www.southampton.ac.uk/edusupport/mental_health_and_wellbeing/index.page" rel="noopener noreferrer">Southampton</a>
        <a href="https://www.lboro.ac.uk/services/cds/wellbeing/mental-health/" rel="noopener noreferrer">Loughborough</a>
        <a href="https://www.sheffield.ac.uk/departments/student-support-services#overview" rel="noopener noreferrer">Sheffield</a>
        <a href="https://www.durham.ac.uk/colleges-and-student-experience/student-support-and-wellbeing/" id="report-now" rel="noopener noreferrer">Durham</a>
    </div>
    </p>
</div>
...
<div class="container-responsive">
    ...
    <p>There are two ways in which you can raise a concern or report a welfare issue to me as the BULSCA Welfare Officer. <strong>The first is to email me</strong> at <a href="mailto:welfare@bulsca.co.uk">welfare@bulsca.co.uk</a>. This way is by nature not confidential but you can provide as many or as few details as you would like to. This will be followed up and dealt with confidentiality and in line with BULSCA policy and your wishes.
        ...
        <br><br>
        <i>Please note there is no ability for me to follow up with you if you use the anonymous welfare reporting form. Instead, the information will simply be used to inform areas of focus for the current and future welfare officers and allow your concerns to be heard.</i>
    </p>
    <br><br>
    <div class="flex items-center justify-center">
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScDnXdmT9k1Xfa95ufxWe0AYQi1rdAw6nPOE2MUiQpsizXheA/viewform" class="md:w-[60%] w-[99%] h-[40rem]" frameborder="0"></iframe>
    </div>
</div>
