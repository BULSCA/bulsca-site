                ...
                <div class="px-6 py-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2 divide-x-2">
                        ...
                        <div class="flex flex-row items-center justify-center pl-4">
                            ...
                            <a href="{{ route('admin.resources.edit', $res->id) }}" class="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
