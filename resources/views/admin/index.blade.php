...
@section('content')
    ...
    <div class="container-responsive">
        <div class="grid md:grid-cols-4 grid-cols-1 gap-6">
            ...
            @if ($currentSeason)
                @can('admin.seasons')
                    <a href="{{ route('admin.season.view', $currentSeason->id) }}"
                        class="rounded-md no-underline border-2 md:col-span-2  hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-blue-600 ">
            ...
            @else
                <a href="{{ route('admin.seasons.create') }}"
                    class="rounded-md no-underline border-2 col-span-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-blue-600 ">
                    <div class="flex flex-col ">
            ...
            @can('admin.seasons')
                <a href="{{ route('admin.seasons') }}"
                    ...
                    <div class="flex flex-col ">
                        <p class=" text-4xl font-bold ">{{ $count['season'] }}</p>
                        <small class="text-base">Seasons</small>
            ...
            @can('admin.competitions')
                <a href="{{ route('admin.competitions') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-purple-600 ">
                    <div class="flex flex-col ">
            ...
            @can('admin.universities')
                <a href="{{ route('admin.universities') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-cyan-400 ">
                    <div class="flex flex-col ">
            ...
            @can('admin.resources')
                <a href="{{ route('admin.resources') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-red-500 ">
                    <div class="flex flex-col ">
                        <p class=" text-4xl font-bold ">{{ $count['resource'] }}</p>
                        <small class="text-base">Resources</small>
            ...
            @can('admin.committees')
                <a href="{{ route('admin.committees') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-fuchsia-500 ">
                    <div class="flex flex-col ">
                        <p class=" text-4xl font-bold ">{{ $count['committee'] }}</p>
                        <small class="text-base">Committee</small>
            ...
            @can('admin.committee_roles')
                <a href="{{ route('admin.committee_roles') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-fuchsia-500 ">
                    <div class="flex flex-col ">
                        <p class=" text-4xl font-bold ">{{ $count['committee_role'] }}</p>
                        <small class="text-base">Committee Role</small>
            ...
            @can('admin.committee_members')
                <a href="{{ route('admin.committee_members') }}"
                    class="rounded-md no-underline border-2 hover:border-gray-300 cursor-pointer py-4 px-6 flex flex-row items-center text-fuchsia-500 ">
                    <div class="flex flex-col ">
                        <p class=" text-4xl font-bold ">{{ $count['committee_member'] }}</p>
                        <small class="text-base">Committee Member</small>
        ...
        <br>
        @if ($currentSeason)
            <h1 class="header"><a class=" no-underline hover:underline"
                    href="{{ route('admin.season.view', $currentSeason->id) }}">Current Season</a> <a
                    href="{{ route('admin.seasons') }}" class="text-base text-gray-400 hover:text-gray-700">(Previous
                    Seasons)</a></h1>
            ...
            <div class="flex flex-row items-center  ">
                @foreach ($currentSeason->competitions()->orderBy('when')->get() as $comp)
                    <div class="flex-1 flex flex-col items-center justify-center">
                        ...
                        <div class="mb-4">
                            <a href="{{ route('admin.competition.view', $comp) }}"
                                class="text-xl font-normal no-underline text-black hover:font-semibold hover:underline">{{ $comp->hostUni->name }}</a>
                        </div>
                        ...
                        <div class="relative border-t border-gray-300 w-full ">
                            <div class="absolute flex w-full bottom-full top-full group items-center justify-center">
                                <span class="competition-status competition-status-finished"></span>
    ...
    <script>
        ...
        watchdog
            .create(document.querySelector('#editor'), {
                ...
                licenseKey: '',
                removePlugins: ['Heading', 'CKBox', 'ImageToolbar', 'Indent', 'List', 'MediaEmbed', 'Table',
                    'TextTransformation', 'BlockQuote', 'Alignment', 'HorizontalLine', 'HTMLEmbed',
                    'GeneralHTMLSupport'
                ]
