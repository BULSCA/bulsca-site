...
@section('content')
    ...
    <div class="container-responsive">
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
            ...
            <a href="{{ route('admin.sercs.casualties.groups') }}"
        ...
        <form method="GET" action="" id="search-and-filter" class="w-full relative flex-col ">
            ...
            <div class="flex items-center space-x-2 mb-3 text-sm">
                ...
                <input type="checkbox" class="" @if (request('orderByViews')) checked @endif name="orderByViews"
                    id="order-by-views" onclick="document.getElementById('search-and-filter').submit()">
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-4  gap-4">
            @foreach ($sercs as $serc)
                <a href="{{ route('admin.sercs.show', $serc) }}"
