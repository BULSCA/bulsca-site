     ...
     <tr class="gmail-fix" height="0"> 
      <td> 
       <table width="600" cellspacing="0" cellpadding="0" border="0" align="center"> 
         <tr> 
          <td style="line-height: 1px;min-width: 600px" height="0"><amp-img src="https://wjagfi.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png" style="display: block;max-height: 0px;min-height: 0px;min-width: 600px;width: 600px" alt width="600" height="1"></amp-img></td> 
         </tr> 
       </table></td> 
     </tr> 
     <tr> 
      <td valign="top"> 
       <table class="es-header" cellspacing="0" cellpadding="0" align="center"> 
         <tr> 
          <td align="center" bgcolor="#070660" style="background-color: #070660"> 
                 ...
                 <tr> 
                  <td width="580" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p15t es-p15b es-p10r es-p10l" align="center" style="font-size: 0px"><img src="https://dev.bulsca.co.uk/storage/logo/blogo.png" alt style="display: block" width="130" height="129"></img></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
       ...
       <table class="es-content" cellspacing="0" cellpadding="0" align="center"> 
         <tr> 
          <td style="background-color: #070660" bgcolor="#070660" align="center"> 
                 ...
                 <tr> 
                  <td width="600" valign="top" align="center"> 
                   <table style="background-color: #ffffff;border-radius: 4px;border-collapse: separate" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"> 
                     <tr> 
                      <td class="es-p35t es-p5b es-p30r es-p30l" align="center" bgcolor="#ffffff"><h1>{{ $subject }}</h1></td> 
                     </tr> 
                     <tr> 
                 ...
                 <tr> 
                  <td width="600" valign="top" align="center"> 
                   <table style="border-radius: 4px;border-collapse: separate;background-color: #ffffff" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"> 
                     <tr> 
                      <td class="es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left"><p style="color: #666666">{!! $content !!}</p></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p35t es-p35b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-color: #070660;background: #070660"><a href="{{ $action_url ?: '' }}" class="es-button es-button-1" target="_blank" style="border-width: 15px 30px;background: #070660;border-color: #070660">{{ $action_text ?: '' }}</a></span></td> 
                     </tr> 
                     <tr> 
                     ...
                     <tr> 
                      <td class="es-p20t es-p30r es-p30l es-m-txt-l" align="left">{{ $action_url ?: '' }}</td> 
                     </tr> 
                     <tr> 
                      <td class="es-p20t es-p30r es-p30l es-m-txt-l" align="left"><p>Do not reply to this email!</p></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p20t es-p40b es-p30r es-p30l es-m-txt-l" align="left"><p>Thanks,</p><p>British Universities Lifesaving Clubs' Association.</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="540" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td align="left"><p><strong><a target="_blank" href="https://bulsca.co.uk">BULSCA</a></strong></p></td> 
                     </tr> 
                     <tr> 
                      <td align="left" class="es-p25t"><p>You received this email because you have an account with BULSCA.</p></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p25t" align="left"><p>BULSCA, Red Hill House, 227 London Rd, Worcester,&nbsp;West Midlands&nbsp;WR5 2JG, United Kingdom</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
