                            ...
                            <div class="flex flex-col max-h-60 overflow-y-scroll thin-scrollbar">
                                ...
                                <template x-for="(taggs, group) in tags">
                                    <div x-data="{
                                        ...
                                        <p class="bg-bulsca text-white text-xs p-1 mb-1 rounded-md cursor-pointer"
                                            x-show="matchAny()" x-text="group == '' ? 'Other' : group "
                                            @click="open = !open">
                                        </p>
            ...
            <div @click.outside="closeModal()">
                <div class="flex items-center justify-between ">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="h-6 w-6 transition-transform hover:rotate-90 cursor-pointer"
                        @click="closeModal()">
