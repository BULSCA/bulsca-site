...
@section('content')
    ...
    <div class="container-responsive">
        <div class="image-link-group">
            ...
            <div class=" image-link "
                style="background-image: url(/storage/photos/champs/2024/champs_2024_light.png); background-size: contain">
                <a href="{{ route('champs.2024') }}" class=" ">Champs 2024 Info</a>
            </div>
            ...
            <div class=" image-link disabled"
                ...
                <a href="{{ route('champs.2024') }}#entries" class=" ">Champs 2024 Entries</a>
            </div>
    ...
    <div class="container-responsive">
        ...
        <p>
            The BULSCA Student Championships is the highlight of the year, where clubs come together and compete in a two
            day competition.
            <br><br>
            On the first day, the competition takes the same form as the RLSS National Speed Championships. Clubs form teams
            consisting of up to twelve members, who take part in various individual and relay events.
            <br><br>
            The second day, takes the form of a normal league competition with the exception of the speed events. The clubs
            from the first day split into three teams of four, who compete in all team events.
            <br>
            <br>
