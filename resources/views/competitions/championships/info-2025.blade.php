    ...
    <div class="container-responsive space-y-2">
        ...
        <div class="flex flex-col lg:flex-row justify-between lg:items-center -mb-1">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-center md:space-x-3">
                <a href="https://forms.gle/D2zoXUR5D5VL4ce26" target="_blank" rel="noopener noreferrer"
        ...
        <div class="sm:grid  xl:grid-cols-3 sm:grid-cols-2  space-y-3  md:space-y-0">
            ...
            <div>
                ...
                <div class=" list-inside list-disc md:w-[50%] ">
                    ...
                    <div class="flex justify-between">Stickers 👀<strong>£5</strong></div>
        ...
        <br>
        <div class="grid-3">
            <div class="file-link" title='Info Pack 2025'>
                <a href='{{ route('view-resource', '2a8539c6-8808-452c-9d59-d2ce37c0c7a5') }}' target='_blank'>
                    <div>
                        <h3>Info Pack 2025</h3>
            ...
            <div class="file-link" title='Entry Pack 2025'>
