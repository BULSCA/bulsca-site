...
@section('content')
    <div class="container-responsive">
        ...
        <div class=" md:space-x-3 md:flex-row flex flex-col justify-center md:justify-start">
            ...
            <a href="{{ $info->form_helpers }}" target="_blank" rel="noopener noreferrer"
                class="btn btn-thinner inline-flex items-center mt-2">Helpers Form <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                </svg></a>
        ...
        <div class="grid-4">
            ...
            <div>
                <h4>Firstaid Kits</h4>
                <p>
                    <strong>Full</strong>: {{ $info->general_fak_full ? ($info->general_fak_full ? 'Yes' : 'No') : 'TBC' }}
                    &nbsp; &nbsp;
                    <strong>Travel</strong>:
                    {{ $info->general_fak_travel ? ($info->general_fak_travel ? 'Yes' : 'No') : 'TBC' }}
                </p>
            </div>
            <div>
                <h4>Teams</h4>
